...
class batch_sampler_CBF:
    def __init__(self):
        ...
        self.collision_batch_total = []

    def sampler_traj(self, state, action, reward, value, collision):
        ...
        self.collision_batch_traj.append(collision)
    ...
    def sampler_total(self, last_value):
        if self.reward_batch_traj:
            ...
            self.collision_batch_total.extend(self.collision_batch_traj)
    ...
    def sampler_get(self):
        ...
        return self.observation_batch_total, self.action_batch_total, self.rtg_batch_total, normalized_gae, \
               self.value_next_batch_total, self.reward_batch_total, self.collision_batch_total
