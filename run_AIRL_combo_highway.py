...
from others.interact_with_envs import AIRL_test_function_Highway
...
def argparser():
    ...
    parser.add_argument('--savedir', help='save directory', default='trained_models/AIRL_benchmark/')
    parser.add_argument('--model_save', help='save model name', default='model.ckpt')
    parser.add_argument('--index', default='model_1')
    parser.add_argument('--reward_savedir', help="reward save directory", default='rewards_record/AIRL_benchmark/')
    ...
    parser.add_argument('--model_restore', help='filename of model to recover', default='80model.ckpt')
...
def main(args):
    ...
    discrim_ratio = int(args.num_expert_dimension / args.min_length)
    ...
    with tf.Session() as sess:
        ...
        for iteration in range(args.iteration):
            ...
            for i in range(args.num_parallel_sampler):
                x1 = AIRL_test_function_Highway.remote(args.envs_1, policy_value, discriminator_value,
                                                       discrete_env_check,
